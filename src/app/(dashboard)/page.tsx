                    ...
                    <div className="px-5 py-5 lg:px-6">
                      <div className="grid gap-4 lg:grid-cols-[1.2fr_1fr_1.1fr_0.8fr_0.9fr_0.8fr_0.7fr] lg:items-center">
                        <div>
                          ...
                          <p className="mt-1 text-xs text-[#7f9485]">{loan.paymentPeriod}</p>
                        </div>

                        <div>
                          <p className="text-sm font-medium text-[#f6f5ef]">{fullName}</p>
                          <p className="mt-1 truncate text-xs text-[#7f9485]">{email}</p>
                        </div>
